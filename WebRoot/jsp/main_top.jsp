...
<table width="100%" height="20" border="0" cellpadding="0" cellspacing="0" bgcolor="1281AF" >
  <tr>
    ...
    <td width="645"> <table width="249" align="right">
      <tr>
        <td width="241" align="center" class="word_white"><a href="/send/jsp/admin_updatePassword.jsp" class="a1">修改密码</a> | <a href="/send/jsp/login.jsp" class="a1">返回首页</a> | <a href="login.jsp" class="a1">退出系统</a></td>
      </tr>
    </table></td>
    <td width="543"></td>
  </tr>
...
<table height="22" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="637" height="183" valign="top" background="../images/logistics_05.jpg"><table width="607" height="168" align="center">
      <tr>
        <td width="409" height="161" valign="bottom"><font color="#FFFFFF"></font></td>
